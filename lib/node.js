...
Node.prototype.ashelper = function(depth, output, plain) {
    ...
    if (this.type == 'text') {
        line.push([plain?'':' <span class="litr">', this.literal, plain?'':'</span>']);
    } else if (this.type == 'question') {
        line.push([plain?'':' <span class="qmark">', this.level, plain?'':'</span>']);
    } else if (this.type == 'anchor') {
        line.push([plain?'':' <span class="qmark">', this.anchorName, plain?'':'</span>']);
    }
    depth += 1;
