    ...
    while ((event = walker.next())) {
        ...
        if (entering) {
            ...
            case 'custom_block':
                ...
                break;
            default:
                if (nodetype in XmlRenderer.extraRenderers)
                    XmlRenderer.extraRenderers[nodetype].call(this, node, attrs);
                break;
            }
...
function addRenderer(type, rf) {
    
    XmlRenderer.extraRenderers[type] = rf;
}
...
XmlRenderer.prototype.addRenderer = addRenderer;
